...
import com.olib.security.jwt.model.AuthorityType;
import com.olib.security.jwt.model.User;
import com.olib.security.jwt.model.UserRequest;
import com.olib.security.jwt.repository.AuthorityRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
	...
	public User save(UserRequest userRequest) {
		...
		Authority authority = authorityRepository.findByName(AuthorityType.ROLE_USER.getAuthority());
